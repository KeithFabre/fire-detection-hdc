# Modified for VGG16 feature extraction + BinHD HDC classification with comprehensive metrics
...
output_file = f'vgg16_adapthd_metrics_{NUM_RUNS}_runs_{datetime.now().strftime("%Y%m%d_%H%M%S")}.json'
final_output = {
    'experiment_info': {
        'total_runs': NUM_RUNS,
