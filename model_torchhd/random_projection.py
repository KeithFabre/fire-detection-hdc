# random-projection encoding with comprehensive metrics collection
import torch
...
for run_num in range(1, NUM_RUNS + 1):
    ...
    run_metrics = {
        ...
        'system_info': {
            ...
            'encoding_type': 'random_projection'
        }
    }
...
output_file = f'hdc_random_projection_metrics_{NUM_RUNS}_runs_{datetime.now().strftime("%Y%m%d_%H%M%S")}.json'
final_output = {
    'experiment_info': {
        'total_runs': NUM_RUNS,
